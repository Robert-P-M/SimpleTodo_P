...
enum class AddTaskStatus : Status {
    SAVING {
        override fun toUiText(): UiText {
            return UiText.StringResourceId(id = R.string.loading_info_start_saving_task)
        }
    },
    DONE {
        override fun toUiText(): UiText {
            return UiText.StringResourceId(id = R.string.loading_info_task_saved)
        }
    },
}