...
interface TaskWithDetailsRepository {
    ...
    suspend fun insert(taskWithDetailsModel: TaskWithDetailsModel): Result<InsertTaskWithDetailsResult, Error>
    suspend fun upsert(taskWithDetailsModel: TaskWithDetailsModel): Result<Unit, Error>
